                ...
                <div class="col-md-6 ">
					...
					<form  action='loginconnect.php' method='post'>
                        ...
                        <div class="row">
                            <div class="col-md-6 ">
                                <div class="form-group">
                                    <textarea name="email" id="email" required="required"  class="form-control" rows="1" placeholder="Email"></textarea>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 ">
                                <div class="form-group">
                                    <textarea name="newpassword" id="newpassword" required="required"  class="form-control" rows="1" placeholder="Password"></textarea>
                                </div>
                                <div class="form-group">
