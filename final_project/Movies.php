            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="home-content">
                        <h1>Watch the latest movies at a cinema near you</h1>
                        <h4 class="lead">Book your tickets on the go, only with a couple of clicks.</h4>
                        <li><form>
                                <input type="text" name="search" data-wow-delay="0.8s" placeholder=" Search for movies, events and sports">
                            </form></li><br><br>
                        <!-- <a href="#" class="main-btn">Go</a> -->
                    </div>
                </div>
            </div>
        </div>
