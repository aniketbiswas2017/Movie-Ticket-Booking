    ...
    <div class="container">
        ...
        <nav id="nav">
            <ul class="main-nav nav navbar-nav navbar-right">
                ...
                <li><a href="index.html"> <span id="city"></a></li>
            </ul>
        </nav>
    </div>
</header>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6">
                ...
                <a href="movies.html" class="btn btn-primary btn-lg btn-block">More Movies</a>
            </div>
            ...
            <div class="col-md-4 col-sm-6">
                ...
                <a href="#" class="btn btn-primary btn-lg btn-block">More Events</a>
            </div>
            <div class="col-md-4 col-sm-6">
                <div class="speaker" data-toggle="modal" data-target="#speaker-modal-1">
                    <div class="speaker-img">
                ...
                <a href="#" class="btn btn-primary btn-lg btn-block">More Sports</a>
            </div>
        </div>
    </div>
</div>
